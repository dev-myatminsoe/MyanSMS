...
public class ConversationAdapter extends ResourceCursorAdapter {
    ...
    public final void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        if (useGridLayout || p.getBoolean(PreferencesActivity.PREFS_HIDE_MESSAGE_COUNT, true)) {
        ...
        if (p.getBoolean("embed_zawgyi", true)) {
            holder.tvBody.setTypeface(Typeface.createFromAsset(context.getAssets(), "zawgyi.ttf"));
